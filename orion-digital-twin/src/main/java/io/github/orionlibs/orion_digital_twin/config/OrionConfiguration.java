package io.github.orionlibs.orion_digital_twin.config;
...
public class OrionConfiguration extends Properties
{
     ...
     */
    public static final String FEATURE_CONFIGURATION_FILE = "/io/github/orionlibs/orion_digital_twin/configuration/orion-feature-configuration.prop";
    ...
    public static OrionConfiguration loadFeatureConfiguration(Properties customConfig) throws IOException
    {
        ...
        {
            throw new IOException("Could not setup feature configuration for Orion Digital Twin: ", e);
        }
    }
